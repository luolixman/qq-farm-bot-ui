  ...
  <div class="settings-page">
    ...
    <div v-else class="grid grid-cols-1 mt-12 gap-4 text-sm lg:grid-cols-2">
      ...
      <div class="card h-full flex flex-col rounded-lg bg-white shadow dark:bg-gray-800">
        ...
        <!-- Save Offline Button -->
        <div
          class="mt-auto flex justify-end gap-2 border-t bg-gray-50 px-4 py-3 dark:border-gray-700 dark:bg-gray-900/50">
          <BaseButton variant="secondary" size="sm" :loading="offlineTesting" :disabled="offlineSaving"
            @click="handleTestOffline">
            测试通知
          </BaseButton>
          <BaseButton variant="primary" size="sm" :loading="offlineSaving" :disabled="offlineTesting"
